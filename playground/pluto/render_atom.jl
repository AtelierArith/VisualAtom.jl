...
# ╔═╡ 333711c1-b847-4566-b002-470ebea65ea2
begin
...
# ╔═╡ 1ef68bae-2ce8-4360-90e7-000254f1eabb
begin
    const PERM = UInt8[
...
# ╔═╡ 1364a282-e62e-11ed-30bb-67fa05d5c9ef
begin
...
# ╔═╡ e028eb05-8ac4-4aab-be31-32f2ab2587b7
struct Config
    #=
...
# ╔═╡ ff78fd8a-f89f-49bf-828e-594af651a480
begin
...
# ╔═╡ 971a2a66-e0eb-4f37-8d54-aaddf946d6f0
begin
    function render!(
        rng::AbstractRNG,
        atom::Atom,
...
# ╔═╡ 49c6138f-56ae-4d32-858b-d16849795907
let
    config = tostruct(Config, TOML.parsefile("../../config.toml"))
    rng = Xoshiro(1)
...
# ╔═╡ b165c85d-96e3-43a2-888b-025deffe828d
...
# ╔═╡ e679da54-43ca-4d6c-a05d-7659f3f84378
...
# ╔═╡ 5becf4c9-92ba-4b43-b3cd-d391a9279477
let
    ...
    #=
    	...
    	=#
    num_categories = 5 # for debugging
    num_instances = 10 # for debugging

    @showprogress for category_id in 0:(num_categories-1)
        generate_instances(config; save_root, category_id, num_instances)
    end
end

# ╔═╡ 2bbc43d8-ebba-4743-a3fc-0216f812f9a5
let
    save_root = "VisualAtom_dataset"
    config = tostruct(Config, TOML.parsefile("../../config.toml"))
...
# ╔═╡ b3dd10a1-4d57-4840-b51b-c14ac27609d8
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "eb61421aeb79461bc93a225cb181fdca377a119f"
